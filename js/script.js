...
(function () {
  // Global variables
  fetch('https://lds-class.onrender.com/check').then((data)=>data.json()).then((res)=>console.log(res))
  ...
  $(function () {
          ...
          beforeSubmit: function (arr, $form, options) {
            ...
            if (isValidated(inputs, captcha)) {
              ...
              for (var j = 0; j < inputs.length; j++) {
                ...
                data[$input[0].attributes.name.nodeValue] = $input[0].value;
              ...
              if (true) {
                ...
                $.post(
                   "https://lds-class.onrender.com/email",
                data
                ).done(function (responceCode) {
		
                  if (responceCode.message== 200) {
                    if (output.hasClass("snackbars")) {
                      ...
                      output.html(captchaMsg[responceCode.message]);
                    }
    ...
    // plugins.form1.on('submit',()=>{
    // 	event.preventDefault();
    // 	console.log('plugins.regula.length')
    ...
    // 	// if(attachFormValidator(plugins.regula)){
    // 	// 	console.log('from 1')

    // 	// }
    // })
    // plugins.form2.on('submit',()=>{
    // 	event.preventDefault();
    // 	console.log('plugins.regula.length')
